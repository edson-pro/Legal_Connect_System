...
const OverviewStatsCard: FC<Props> = ({ hideCases }) => {
  return (
    <div
      className={`relative px-4 py-3 mt-6 border border-gray-300/60 grid rounded-xl gap-12 ${
        hideCases ? "grid-cols-2" : "grid-cols-3"
      }`}
    >
      {/* separators */}
